...
public class TracerTest extends VertxTestBase {
  ...
  protected VertxOptions getOptions() {
    return super.getOptions().setTracer(tracer = new Tracer() {
      @Override
      public Object receiveRequest(Map context, Object request) {
        return tracer.receiveRequest(context, request);
      }
      @Override
      public void sendResponse(Map context, Object response, Object payload, Throwable failed) {
        tracer.sendResponse(context, response, payload, failed);
      }
      @Override
      public Object sendRequest(Map context, Object request) {
        return tracer.sendRequest(context, request);
      }
      @Override
      public void receiveResponse(Map context, Object response, Object payload, Throwable failed) {
        tracer.receiveResponse(context, response, payload, failed);
      }
    });
  }
  ...
  public void testHttpServer() throws Exception {
    ...
    tracer = new Tracer() {
      ...
      public void sendResponse(Map context, Object response, Object payload, Throwable failed) {
        ...
        assertTrue(response instanceof HttpServerRequest);
        assertNull(failed);
  ...
  public void testHttpClientRequest() throws Exception {
    ...
    tracer = new Tracer() {
      @Override
      public Object sendRequest(Map context, Object outbound) {
